import { Award, BookOpen, ChevronRight, GraduationCap, Play, Target, TrendingUp, Trophy, Users, Zap } from 'lucide-react';
...
export const LandingPage: React.FC<LandingPageProps> = ({ onGetStarted }) => {
  const features: FeatureItem[] = [
    ...
    {
      icon: <Target className="w-8 h-8 text" />,
  ...
  return (
    <div className="min-h-screen h-screen overflow-y-auto bg-gradient-to-br from-white via-yellow-50 to-red-50">
      {/* Navigation */}
